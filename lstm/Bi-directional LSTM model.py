...
def lstm():
    ...
    model.add(Bidirectional(LSTM(50, input_shape=data_shape1, return_sequences=False)))
...
y_testclass = np.argmax(y_test, axis = 1) # convert one hot label to the respective classes
